...
let
  spicePkgs = spicetify-nix.packages.${pkgs-stable.system}.default;
in
{
  ...
  programs.spicetify =
    let
      ...
      # spicetify-nix
      officialThemesOLD = pkgs-stable.fetchgit {
    ...
    in
    {
      ...
      spicetifyPackage = pkgs-stable.spicetify-cli.overrideAttrs (oa: rec {
        pname = "spicetify-cli";
        version = "2.14.1";
        src = pkgs-stable.fetchgit {
