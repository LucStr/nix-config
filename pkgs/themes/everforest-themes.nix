...
stdenvNoCC.mkDerivation {
  ...
  installPhase = ''
    ...
    cp --archive themes/. $out/share/themes/.

    mkdir -p $out/share/icons/
    cp --archive icons/Everforest-Dark $out/share/icons/Everforest-Dark
    cp --archive icons/everforest_light $out/share/icons/Everforest-Light
  '';
}